...
// What does this mean?: create an endpoint which is protected by the strategy
// Just an example of implementing the strategy.
...
// In resposne to the following error:
...
// assert.equal(user.exec().constructor, global.Promise);
